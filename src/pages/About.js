...
const About = () => {
  return (
    <div className="about-page">
      ...
      <p>
        En tant que développeur web expérimenté, j'ai acquis une compétence
      ...
      <h2>Nos Résultats</h2>
      <p>
        Notre approche orientée vers les résultats garantit que votre site web
        sera non seulement esthétiquement attrayant, mais également optimisé
        pour le référencement et les performances. Faites confiance à BEPAG pour
        transformer votre vision en réalité et donner vie à vos projets les plus
        ambitieux.
      </p>
